...
function calcMaterial(){
 ...
 try{
  ...
  const areaName=document.getElementById('material-name').value.trim();materialEstimates.push({title:`${labels[type]}${areaName?` — ${areaName}`:''}`,result,detail});
